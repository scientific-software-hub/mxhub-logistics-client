...
<template>
    <section>
        <h2 class="text-3xl text-center font-bold py-2">Scan Container and Tray</h2>
        <form>
            <div class="mb-3 px-2">
        ...
        onSetLocation: function(event) {
            ...
            if (this.barcode && this.location) {
                ...
                .then(function(response) {
                    ...
                    // Changed because we don't get the container id back from synchweb
                    // We get a CONTAINERHISTORYID instead
                    if ( json['CONTAINERHISTORYID'] > 0 ) {
                        ...
                        if (json['reason']) {
                            ...
                            message = "Error - no container history id returned"                            
                        }
                        isError = true
                        self.playFail();
                    }
